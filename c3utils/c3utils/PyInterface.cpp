    ...
    namespace python {
        PYBIND11_MODULE(py_c3utils, m) {
            ...
            py::class_<c3utils::Vector2>(m, "Vector2")
                ...
                .def(py::init<const std::vector<float64_t>&>())
            ...
            m.def("NEU_to_self", &c3utils::NEU_to_self, py::arg("neu"), 
                py::arg("roll"), 
                py::arg("pitch"), 
                py::arg("yaw"));
            m.def("get_NED_from_NEU", &c3utils::get_NED_from_NEU, 
                py::arg("neu"), 
                py::arg("mid") = ::std::vector<float64_t>{ 0, 0, 5000 });
        }
    }
}
